...
RCC(Reset Control Clock) 클록에서 HSE 클록을 바꿔줘야한다
 * RCC 란 칩 내부에 공급되는 클럭
...
* 참고 
  ...
  HSE : (High-Speed External) 외부 클럭으로 오차가 덜하다
...
![RCC 설정변경 핀맵 변경 ](image-1.png)
![RCC 설정에 따른 핀맵 변경 후](image.png)

** RCC 사용전과 후의 핀맵 차이 볼수 있다.**
...
코드생성할때 
- tool chain truesutio 설정
- generate peripheral initialization as a pair of 'c/h' file per peripheral 체크하기
...
1. 기본강의
https://www.youtube.com/watch?v=WzmPlObIr_c&list=PLUaCOzp6U-RqMo-QEJQOkVOl1Us8BNgXk
